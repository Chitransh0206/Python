...
class Train:
    def __init__(slf, trainNo):    #HOGA KUCH NHI SELF KI JAGAH KUCH AUR LIKHENGE TO BUT GOOD PRACTICE IS TO WRITE SELF
        slf.trainNo = trainNo
    
    def book(abcd, fro, to):
        print(f"Ticket is booked in train no: {abcd.trainNo} from {fro} to {to}")
